...
-- Script date 6/26/2020 12:50:45 AM
...
--
-- Drop procedure `Proc_ValidateToken`
--
DROP PROCEDURE IF EXISTS Proc_ValidateToken;
...
--
-- Create procedure `Proc_ValidateToken`
--
CREATE PROCEDURE Proc_ValidateToken (IN v_UserID int)
SQL SECURITY INVOKER
COMMENT 'Kiểm tra user có trong hệ thống'
BEGIN
  SELECT
    CASE WHEN U.UserID IS NOT NULL THEN 1 ELSE 0 END AS Valid
  FROM user AS U
...
--
CREATE PROCEDURE Proc_Login (IN v_UserName varchar(255), IN v_Password varchar(255))
SQL SECURITY INVOKER
COMMENT 'đăng nhập'
BEGIN
  SELECT
...
(1, 'vietcuong.uet@gmail.com', 'Nguyễn Việt Cường', 1, NULL, 'nvcuong1@gmail.com', 3, '2020-06-24 23:14:16', 'admin', '2020-06-24 23:14:16', 'admin', '123', '', 'Teacher', 'Giáo Viên', NULL);
